...
```js title="동작 예시" showLineNumbers{88} {1, 4-12} {15-17}#error /console.log/
console.log('start');
...
`const test = console.log("TEST"){:js}`

1. 전역 실행 컨텍스트가 생성되고 콘솔에 `start`를 출력 (`console.log{:js}`의 실행 과정은 생략)
